...
import {
  ...
  export default function createStartScene(engine: Engine) {
    ...
    that.box = createBox(that.scene, 2, 6, 2);
    that.box = createBox(that.scene, 2, 15, 2);
    that.box = createBox(that.scene, 2, 10, 2);
    that.box = createBox(that.scene, 3, 3, 3);
    that.box = createBox(that.scene, -4, 3, -4);
    that.box = createBox(that.scene, -4, 3, 4);
    that.box = createBox(that.scene, 4, 3, -4);
    that.box = createBox(that.scene, 0, 8, 0);
    that.box = createBox(that.scene, 0, 12, 0);
    that.box = createBox(that.scene, 0, 18, 0);
